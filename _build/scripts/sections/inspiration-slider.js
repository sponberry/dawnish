...
const sectionEvents = {
  ...
  initSlider(sliderEl) {
    ...
    const [desktopSlides, deviceSlides, mobileSlides] = sliderEl.hasAttribute(selectors.slidesVisibleAttribute)
      ? sliderEl.getAttribute(selectors.slidesVisibleAttribute).split('/')
      : ['auto', 'auto', 'auto'];
